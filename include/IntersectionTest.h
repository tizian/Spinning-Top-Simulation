...
namespace IntersectionTest {
    ...
    static bool intersectionPointBox(glm::vec3 pointWorld,
                                     glm::vec3 boxOrigin,
                                     glm::vec3 boxRadii,
                                     glm::mat4 inverseboxModel) {
    ...
    static bool intersectionRayTriangle(const glm::vec3 point1,
    ...
    static bool intersectionRayBox(glm::vec3 rayOrigin,
    ...
    static bool intersectionTriangleBox(glm::vec3 point1,
                                        glm::vec3 point2,
                                        glm::vec3 point3,
                                        glm::vec3 origin,
                                        glm::vec3 radii) {
    ...
    static bool intersectionTriangleTriangle(Triangle one,
                                             Triangle two,
                                             glm::vec3 &outputPoint,
                                             glm::vec3 &ouputNormal) {
